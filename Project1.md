...
|:-----------:|:-----------------------------------------------------------:|:------------------------------------------------------------------------------------------------:|:-------------:|:----------------------:|-----------|
| 1           | Create system diagram                                       | To have a clear idea of the hardware and software requirements for the proposed solution         | 10min         | Sep 30                 | B         |
| 2           | Create flow diagrams                                        | To have clear ideas on how to code and how the programme would work                              | 40min         | Sep 30                 | B         |
| 3           | Code the base of my game                                    | The game has a base, which is the labyrinth                                                      | 40min         | Oct 7                  | C         |
| 4           | Caesar cypher diagram                                       | To know how to code the Caesar cypher                                                            | 5min          | Oct 14                 | B         |
| 5           | Write proposed solution and success criteria                | For having clear ideas about the game, the design, the software and the goals.                   | 10min         | Oct 14                 | A         |
| 6           | Answer personal relevance question                          | So the client knows why I chose the topic of the game                                            | 5min          | Oct 14                 | B         |
| 7           | Record video of MVP                                         | So the client can see the progress                                                               | 5min          | Oct 14                 | D/E       |
| 8           | Draw user interface sketch                                  | To know how the game will look like                                                              | 5min          | Oct 17                 | B         |
| 9           | Code the loops for the movement of Theseus and the Minotaur | So the user can move across the labyrinth                                                        | 30min         | Oct 18                 | C         |
| 10          | Code the function for the time and calculate score          | To have a timer and show the score later                                                         | 1h            | Oct 18                 | C         |
| 11          | Code exit conditions                                        | To finish the game and win or lose the game                                                      | 40min         | Oct 19                 | C         |
| 12          | Code some improvements                                      | General improvements                                                                             | 20min         | Oct 21                 | C         |
| 13          | Code some improvements                                      | General improvements                                                                             | 20min         | Oct 22                 | C         |
| 14          | Test the game                                               | My parents, sister and grandparents have played and undertood the game                           | 1h            | Oct 23                 | E         |
| 15          | Improve user intuitive instructions                         | Change some codes so it is easier to the user to understand the game, based on the previous test | 20min         | Oct 23                 | C         |
| 16          | Create a database system to store the score and the username| So the user can play multiple times comparing new and old scores                                 | 2h            | Oct 24                 | C         |
| 17          | Write future improvements ideas                             | So the client can see that the game can be improved during the time                              | 5min          | Oct 24                 | B         |
